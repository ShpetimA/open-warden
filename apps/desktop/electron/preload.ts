...
const desktopBridge: DesktopBridge = {
  ...
  listPullRequests: (input) => invoke("listPullRequests", input),
  getPullRequestConversation: (input) => invoke("getPullRequestConversation", input),
  getPullRequestFiles: (input) => invoke("getPullRequestFiles", input),
  getPullRequestPatch: (input) => invoke("getPullRequestPatch", input),
