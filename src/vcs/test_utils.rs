...
pub fn make_temp_dir(prefix: &str) -> PathBuf {
    ...
    fs::create_dir_all(&dir).unwrap_or_else(|e| panic!("failed to create temp dir: {}", e));
    dir
}
...
impl RepoGuard {
    ...
    pub fn new() -> Self {
        ...
        let dir = make_temp_dir("agent-leash-test");
...
impl JjRepoGuard {
    ...
    pub fn new() -> Option<Self> {
        ...
        let original = env::current_dir().expect("failed to get cwd");
        let dir = make_temp_dir("agent-leash-jj-test");
